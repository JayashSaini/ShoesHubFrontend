...
const Product: React.FC = () => {
  ...
  useEffect(() => {
    gsap.fromTo(
      ...
      { opacity: 1, duration: 2, ease: "power3.out" } // End with opacity 1 after a delay of 0.5 seconds
    );
  }, [productId]);
  ...
  return (
    <>
      <div className="w-full min-h-[100vh]  relative md:px-10 sm:px-6 px-4 py-4">
        ...
        {!isLoading ? (
          <div>
            <div
              ref={productRef}
              className="w-full flex flex-col md:flex-row   my-5 gap-3 "
            >
              {/* Product Images */}
